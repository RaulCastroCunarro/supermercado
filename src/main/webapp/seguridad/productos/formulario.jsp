				...
				<div id="formulario" class="card w-100">
					<div class="form-group card-body shadow">
						<label for="id">ID</label> <input type="text" name="id"
							...
							readonly class="form-control mb-2 p-2" /> <label for="nombre">Nombre</label>
						<input type="text" name="nombre" placeholder="Nombre"
							value="${producto.nombre}" required="required" pattern="{1,100}"
							class="form-control mb-2 p-2" /> <label for="imagen">Imagen</label>
						<input type="text" id="imagen" name="imagen" placeholder="URL de la imagen"
							value="${producto.imagen}" required="required"
						...
						<label for="precio">Precio</label> <input type="text"
							...
							required="required" class="form-control mb-2 p-2" /> <label
							for="descuento">Descuento</label> <input type="text"
							name="descuento" placeholder="Descuento"
							value="${producto.descuento}" required="required"
							pattern="(100)|(0*\d{1,2})" class="form-control mb-2 p-2" /> <label
